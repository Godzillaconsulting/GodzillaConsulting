...
export const PAGE_SECTIONS = [
 { id:'hero', label:'Encabezado principal (Hero)', icon:'layers', tag:'INICIO' },
 { id:'servicios', label:'Servicios', icon:'bolt', tag:'SERVICIOS' },
 { id:'cultura', label:'Cultura', icon:'corporate_fare', tag:'CULTURA' },
 { id:'portafolio', label:'Casos de Éxito', icon:'workspace_premium', tag:'PORTAFOLIO'},
 { id:'recursos', label:'Recursos', icon:'auto_stories', tag:'RECURSOS' },
 { id:'paquetes', label:'Paquetes Grid', icon:'inventory_2', tag:'PAQUETES' },
 { id: 'paquete-posicionamiento-social', label: 'Posicionamiento', icon: 'campaign', tag: 'LANDING' },
 { id: 'paquete-expansion', label: 'Expansión', icon: 'rocket_launch', tag: 'LANDING' },
 { id: 'paquete-control-ia', label: 'Control IA', icon: 'smart_toy', tag: 'LANDING' },
 { id: 'paquete-elite', label: 'Élite', icon: 'crown', tag: 'LANDING' },
 { id: 'servicio-bots', label: 'S. Bots', icon: 'smart_toy', tag: 'SERVICIO' },
 { id: 'servicio-audiovisual', label: 'S. Video', icon: 'movie', tag: 'SERVICIO' },
 { id: 'servicio-embudos', label: 'S. Embudos', icon: 'filter_alt', tag: 'SERVICIO' },
 { id: 'servicio-redes', label: 'S. Redes', icon: 'share', tag: 'SERVICIO' },
 { id: 'servicio-seo', label: 'S. SEO', icon: 'search', tag: 'SERVICIO' },
 { id: 'servicio-crm', label: 'S. CRM', icon: 'database', tag: 'SERVICIO' },
 { id: 'landing-recurso-prompts', label: 'L. Protocolo Lázaro', icon: 'link', tag: 'LANDING' },
 { id: 'landing-recurso-boveda-scripts', label: 'L. Bóveda Scripts', icon: 'link', tag: 'LANDING' },
 { id: 'landing-recurso-crm', label: 'L. Tablero Control', icon: 'link', tag: 'LANDING' },
 { id: 'footer', label: 'Footer', icon: 'pin', tag: 'PIE' },
];
