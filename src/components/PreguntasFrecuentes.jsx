...
const defaultFaqs = [
 ...
 answer:'Ofrecemos una gama completa de servicios digitales que incluyen automatización de bots, producción audiovisual estratégica, diseño de embudos de venta, gestión de redes sociales, optimización SEO y CRM personalizado.',
 },
 {
 orden: 2,
 question:'¿Cuánto tiempo tarda en verse resultados?',
 answer:'Los tiempos varían según el servicio. Las campañas de captación pueden generar leads en días, mientras que el SEO y el posicionamiento de marca suelen tomar entre 3 y 6 meses para mostrar resultados significativos.',
 },
 {
 orden: 3,
 question:'¿Trabajan con clientes fuera de México?',
 answer:'Sí, tenemos clientes en diversos países. Nuestras estrategias digitales son globales y podemos adaptarnos a diferentes mercados e idiomas.',
 },
 {
 orden: 4,
 question:'¿Cómo es el proceso de contratación?',
 answer:'El proceso comienza con una sesión de estrategia gratuita donde analizamos tus necesidades. Luego presentamos una propuesta personalizada, firmamos el contrato y comenzamos la fase de implementación.',
 },
 {
 orden: 5,
 question:'¿Ofrecen garantías sobre los resultados?',
 answer:'Trabajamos con métricas claras y objetivos definidos desde el inicio. Si bien no podemos garantizar resultados exactos (ninguna agencia honesta puede), nos comprometemos con la transparencia total y la optimización continua de cada campaña.',
 },
 {
 orden: 6,
 question:'¿Cuáles son sus métodos de pago?',
 answer:'Aceptamos transferencia bancaria, tarjeta de crédito/débito y pagos internacionales vía PayPal o Stripe. Los planes se facturan mensualmente y no hay contratos de largo plazo obligatorios.',
 },
];
