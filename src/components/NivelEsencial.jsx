        ...
        <div className="bg-black min-h-screen text-white pt-20">
            ...
            <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center h-full pt-10 pb-8">
                    ...
                    <h1 className="text-[5rem] md:text-[8rem] lg:text-[10rem] font-bold leading-[0.9] tracking-tight mb-16 drop-shadow-2xl">
                        NIVEL<br />
                        ESENCIAL
                    </h1>
                    ...
                    <p className="text-xs md:text-sm font-light italic max-w-3xl mx-auto text-gray-300 px-4 mt-auto drop-shadow-md">
                        Si en <span className="font-bold text-white not-italic">7 días hábiles</span>, tu sistema no está instalado, respondiendo mensajes y capturando datos de tus clientes automáticamente, te regalamos el siguiente mes de servicio completamente <span className="font-bold text-white not-italic">GRATIS</span>.
                    </p>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 lg:gap-16 items-center">
                        ...
                        <div className="w-full lg:w-[55%] bg-[#1c1c1c] border border-red-600 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative">
                            ...
                            <div className="bg-[#FACC15] text-black font-bold text-sm px-4 py-2 rounded-lg inline-block mb-10 w-fit">
                                Ideal para el que no confía y se ha vuelto esclavo de su propio éxito
                            </div>
                            ...
                            <div className="space-y-6 mb-10 w-full md:pr-4">
                                ...
                                <div className="flex items-start gap-4 pb-6 border-b border-gray-700">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-bold text-lg text-white mb-0.5">Agente IA (Web + WhatsApp):</span>
                                        <span className="text-gray-300 text-sm leading-relaxed">Configuración de cerebro digital para<br />responder dudas frecuentes y horarios 24/7</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 pb-6 border-b border-gray-700">
                                    ...
                                    <div className="flex flex-col justify-center min-h-[24px]">
                                        <span className="font-bold text-lg text-white leading-tight">Respuesta en menos de 5 segundos<br />24 horas al día, 7 días a la semana</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 pb-6 border-b border-gray-700">
                                    ...
                                    <div className="flex flex-col justify-center min-h-[24px]">
                                        <span className="font-bold text-lg text-white">Captura de datos automática</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="text-center pt-2">
                                <div className="flex justify-center items-baseline gap-2 mb-8">
                                    <span className="text-[2.75rem] md:text-5xl font-bold text-white">$7,900</span>
