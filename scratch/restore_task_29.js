...
async function run() {
  try {
    ...
    const status = "pending_render";
    const publish_targets = ["instagram"];
    
    const media_payload = [
      {
        "url": "/outputs/task_29_final.mp4",
    ...
    // 3. Reset the primary key sequence so that the next generated task has ID 30
    ...
    console.log("Task 29 successfully inserted and PK sequence reset.");
  } catch(e) {
