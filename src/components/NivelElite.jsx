...
const defaultContent = {
    ...
    heroTitle: 'NIVEL\nÉLITE',
    heroDisclaimer: 'Si no aumentamos tus citas en un <span className="font-bold text-white not-italic">20% en 90 días hábiles</span>, trabajaremos <span className="font-bold text-white not-italic">gratis</span>.',
    planTarget: 'Ideal para el que pierde millones por el caos y la falta de datos.',
...
const NivelElite = () => {
    ...
    useEffect(() => {
        ...
        client.fetch(`*[_type == "landingPaquete" && slug.current == "nivel-elite"][0]{..., "videoFileUrl": videoFile.asset->url}`)
            .then((data) => {
                if (data) {
        ...
        <div className="bg-black min-h-screen text-white pt-20">
            ...
            <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center h-full pt-10 pb-8">
                    ...
                    <h1
                        className="text-[5rem] md:text-[8rem] lg:text-[10rem] font-bold leading-[0.9] tracking-tight mb-16 drop-shadow-2xl"
