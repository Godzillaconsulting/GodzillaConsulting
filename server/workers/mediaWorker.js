...
async function generateGoogleImage(prompt, outputPath, aspect_ratio = '9:16', refImageBytes = null, refMimeType = 'image/jpeg') {
    ...
    console.warn(`[GoogleImageGen] ❌ Todas las APIs de Google Imagen fallaron. Usando copia de test_turbo.jpg.`);
    ...
    await new Promise((resolve, reject) => {
        ffmpeg(tempPath)
            ...
            .outputOptions([
                ...
                '-c:v libx264', '-preset veryfast', '-threads 2', '-crf 30', '-pix_fmt yuv420p', '-an'
            ])
            .save(tempCropped)
