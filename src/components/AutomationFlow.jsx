...
const FLOW_TEMPLATES = [
  {
    ...
    nodes: [
      ...
      /* --- RESOLUCIÓN / SALIDAS (Lado Derecho) --- */
    ...
    edges: [
      ...
      { id: 'eb5', source: 'core1', target: 'bot5', color: '#f97316' }, /* El cerebro manda la señal al Newsletter */
      { id: 'eb6', source: 'bot6', target: 'core1', color: '#8b5cf6' }, /* Trends le avisa al cerebro */
      ...
      { id: 'ef1', source: 'out2', target: 'fin1', color: '#6366f1' }, /* CRM trigger Stripe */
      { id: 'ef2', source: 'out2', target: 'fin2', color: '#00e599' }, /* CRM guarda en Neon */
      { id: 'ef3', source: 'out1', target: 'fin2', color: '#00e599' }, /* Calendario guarda en Neon */
    ],
  },
  {
