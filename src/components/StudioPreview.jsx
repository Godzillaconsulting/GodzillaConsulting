  ...
  return (
    <div className="min-h-screen bg-black text-white pt-16 pb-10 px-6">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6 uppercase tracking-tighter" dangerouslySetInnerHTML={{ __html: d.heroTitle || 'Plan' }} />
        {d.videoFileUrl && (
          <video src={d.videoFileUrl} autoPlay muted loop playsInline className="w-full max-w-md mx-auto rounded-3xl shadow-2xl mb-6 object-cover" style={{ maxHeight: '300px' }} />
        )}
        {!d.videoFileUrl && <div className="w-full max-w-md mx-auto h-48 bg-neutral-900 rounded-3xl mb-6 border border-neutral-800 flex items-center justify-center text-neutral-700 text-sm">Sin video</div>}
      </div>
      ...
      <div className="max-w-2xl mx-auto bg-[#1c1c1c] border border-[#CC0000] rounded-3xl p-8 shadow-2xl">
        ...
        <h2 className="text-4xl font-black mb-4 uppercase" dangerouslySetInnerHTML={{ __html: d.heroTitle || 'Plan' }} />
...
const SECTION_IDS = {
  'hero':      'inicio',
  'servicios': 'servicios',
  'casos':     'portafolio',    // CasosExito usa id="portafolio"
  'recursos':  'recursos',
...
const HIGHLIGHT_MAP = {
  'hero': {
    'section':    ['#inicio'],
    'title':      ['#inicio h1', '#inicio [class*="text-4xl"]', '#inicio [class*="text-5xl"]'],
    'subtitle':   ['#inicio p'],
    'ctaText':    ['#inicio a'],
    'imageUrl':   ['#inicio img'],
    'videoUrl':   ['#inicio video'],
    'bgColor':    ['#inicio'],
    'accentColor':['#inicio a', '#inicio h1'],
  },
  'servicios': {
    'section':    ['#servicios'],
    'title':      ['#servicios h2'],
    'elements':   ['#servicios .grid, #servicios ul'],
    'videoUrl':   ['#servicios video'],
    'bgColor':    ['#servicios'],
    'accentColor':['#servicios h2'],
  },
  'cultura': {
    'section':    ['section[id="cultura"], div[id="cultura"]'],
    'title':      ['[id="cultura"] h2'],
    'imageUrl':   ['[id="cultura"] img'],
  },
  'casos': {
    'section':    ['#portafolio'],
    'title':      ['#portafolio h2'],
    'elements':   ['#portafolio [class*="rounded"]'],
    'imageUrl':   ['#portafolio img'],
    'bgColor':    ['#portafolio'],
  },
  'recursos': {
...
const LANDING_HIGHLIGHT = {
  'heroTitle':   ['h1'],
  'heroTopText': ['p.text-lg'],
  'planPrice':   ['[class*="text-5xl"]'],
  'guaranteeText': ['[class*="rounded-2xl"]'],
  'imageUrl':    ['video, img'],
  'videoFileUrl': ['video'],
  'accentColor': ['h1', '[class*="bg-\\[\\#CC0000\\]"]'],
};
