...
const pool = new Pool({
  connectionString: 'postgresql://neondb_owner:npg_3vJ9zkfNMgOt@ep-summer-thunder-ak5f71ru-pooler.c-3.us-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
});
